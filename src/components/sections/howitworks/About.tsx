...
export default function About() {
  return (
    <section className="py-6">
        <Container className="md:flex bg-[#E3FF99] sm:rounded-2xl rounded-3xl max-sm:mx-3 sm:max-xl:mx-6 lg:pt-12 pt-4 sm:pb-2">
            ...
            <div className="lg:hidden max-sm:mt-13 flex justify-center items-center rounded-2xl px-10 max-sm:py-5 py-4 sm:w-fit max-lg:bg-[#95D21A]">
            ...
            <div className="max-lg:hidden  rounded-xl p-4 w-fit shadow-[0px_5px_10px_#C5C8938B]">
                <Image
